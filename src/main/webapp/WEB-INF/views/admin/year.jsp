		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="myNavbar">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="/admin/year">Year</a></li>
...
<div class="row">
	<div class="col-md-3 col-xs-12">
		<form:form class="form-horizontal filter" action="/admin/year"
	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				<form:form class="form-horizontal" action="/admin/year"
					method="POST" modelAttribute="year">
					<div class="form-group">
						<label for="alcoholContent" class="col-sm-2 control-label">Year</label>
						<div class="col-sm-10">
							<form:input class="form-control" path="year" id="year" />
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-10 col-sm-offset-2 control-label" for="year"
		...
		<c:forEach items="${page.content}" var="year">
			<div class="row">
				<div class="col-md-4 col-xs-4">${year.year}</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-success"
						href="/admin/year/update/${year.id}<custom:allParams/>">update</a>
				</div>
				<div class="col-md-4 col-xs-4">
					<a class="btn btn-danger"
						href="/admin/year/delete/${year.id}<custom:allParams/>">delete</a>
				</div>
			</div>
		</c:forEach>
	</div>
